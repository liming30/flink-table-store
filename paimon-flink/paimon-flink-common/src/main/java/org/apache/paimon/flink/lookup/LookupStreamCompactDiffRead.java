...
public class LookupStreamCompactDiffRead extends AbstractDataTableRead<KeyValue> {
    private final SplitRead<InternalRow> fullPhaseMergeRead;
    private final SplitRead<InternalRow> incrementalDiffRead;

    public LookupStreamCompactDiffRead(MergeFileSplitRead mergeRead, TableSchema schema) {
        super(schema);
